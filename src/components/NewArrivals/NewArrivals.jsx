...
// 8 Dynamic Products Data (Backend/API Ready)
...
function NewArrivals() {
  // Toggle state to view all 8 products or just initial 4
  const [showAll, setShowAll] = useState(false);

  // Display 4 items initially, or all 8 when toggled
  const displayedProducts = showAll ? ALL_NEW_PRODUCTS : ALL_NEW_PRODUCTS.slice(0, 4);
